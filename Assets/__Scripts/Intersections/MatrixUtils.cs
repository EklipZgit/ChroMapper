...
{
    public static void FastMultiplyPoint3x4(this in Matrix4x4 matrix, in Vector3 point, ref Vector3 result)
    {
    ...
    public static void FastMultiplyDirection(this in Matrix4x4 matrix, in Vector3 vector, ref Vector3 result)
    {
