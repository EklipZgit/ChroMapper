...
public sealed class CustomBloom : PostProcessEffectSettings
{
    ...
    public FloatParameter intensity = new() { value = 1f };
...
public sealed class CustomBloomRenderer : PostProcessEffectRenderer<CustomBloom>
{
    ...
    public override void Init()
    {
        ...
        for (var i = 0; i < MaxPyramidSize; i++)
        {
            ...
            {
                Down = Shader.PropertyToID("_BloomMipDown" + i), Up = Shader.PropertyToID("_BloomMipUp" + i)
            };
        }
    }
    ...
    public override void Render(PostProcessRenderContext context)
    {
        ...
        sheet.properties.SetFloat(intensityId, intensity);
