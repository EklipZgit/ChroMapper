...
public class TimeMappingController : MonoBehaviour
{
    ...
    {
        TrackTimeMapping();
        LoadedDifficultySelectController.OnLoadedDifficultyChanged += TrackTimeMapping;
    }

    private void OnDestroy() => LoadedDifficultySelectController.OnLoadedDifficultyChanged -= TrackTimeMapping;
