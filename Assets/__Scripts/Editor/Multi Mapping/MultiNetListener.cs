...
public class MultiNetListener : INetEventListener, IDisposable
{
    ...
    {
        audioTimeSyncController = BeatmapObjectContainerCollection.GetCollectionForType(ObjectType.Note).BeatmapContext.Atsc;
        ...
        BeatmapActionContainer.OnActionCreated += BeatmapOnActionContainerOnActionCreated;
        RegisterPacketHandler<ActionCreatedPacketHandler>(PacketId.ActionCreated);
        BeatmapActionContainer.OnActionUndo += BeatmapOnActionContainerOnActionUndo;
        RegisterPacketHandler<ActionUndoPacketHandler>(PacketId.ActionUndo);
        BeatmapActionContainer.OnActionRedo += BeatmapOnActionContainerOnActionRedo;
