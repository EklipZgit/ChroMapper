...
public class DingOnNotePassingGrid : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        beatSaberCutCallbackController.OnNotePassedThreshold += PlaySound;
        defaultCallbackController.OnNotePassedThreshold += TriggerBongoCat;
        beatSaberCutCallbackController.OnChainPassedThreshold += PlaySound;
    }
