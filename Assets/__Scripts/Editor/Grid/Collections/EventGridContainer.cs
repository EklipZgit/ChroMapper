                                  ...
                                  IEditorStateProvider
{
    ...
    public void CaptureEditorState(SimpleJSON.JSONObject data)
    {
        ...
        Debug.Log(
            $"[EditorState] Captured Basic Event light-ID page {EventTypeToPropagate}; "
            + $"active: {lightIdPageActive}.");
    }
    ...
    public void LoadEditorState(SimpleJSON.JSONNode data)
    {
        ...
        {
            Debug.LogWarning($"[EditorState] Cannot restore missing Basic Event light-ID page {eventType}.");
            return;
        }
        ...
        Debug.Log($"[EditorState] Restored Basic Event light-ID page {eventType}; active: {lightIdPageActive}.");
    }
