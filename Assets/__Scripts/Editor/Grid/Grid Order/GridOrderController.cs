...
public class GridOrderController : MonoBehaviour
{
    ...
    private void Start() => gridRotationController.OnObjectRotationChanged += MarkDirty;
    ...
    private void OnDestroy() => gridRotationController.OnObjectRotationChanged -= MarkDirty;
