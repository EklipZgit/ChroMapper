                              ...
                              CMInput.IEventPlacementActions
{
    ...
    protected override void HandlePlacementToData(PlacementInputState inputState)
    {
        ...
        if (CanPlaceChromaEvents
            && dropdown.Visible
            && context.TrackDefinitions.GetBasicOrDefault(QueuedData.Type).Kind == BasicEventKind.Lights
    ...
    public void UpdateQueuedValue(int value)
    {
        ...
        if (context.TrackDefinitions.GetBasicOrDefault(QueuedData.Type).Kind == BasicEventKind.IntValue
    ...
    {
        if (context.TrackDefinitions.GetBasicOrDefault(QueuedData.Type).Kind != BasicEventKind.Lights)
        {
    ...
    {
        if (context.TrackDefinitions.GetBasicOrDefault(QueuedData.Type).Kind != BasicEventKind.Lights) return;
    ...
    {
        base.CreateVisual();
        PlacementVisualContainer!.TrackDefinitions = context.TrackDefinitions;
    }
