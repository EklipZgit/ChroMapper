                              ...
                              CMInput.IEventPlacementActions
{
    ...
    protected override void UpdateData(PlacementInputState inputState)
    {
        ...
        if (CanPlaceChromaEvents
            && dropdown.Visible
            && context.TracksDefinition.Basic[QueuedData.Type].Kind == BasicEventKind.Lights
    ...
    public void UpdateQueuedValue(int value)
    {
        ...
        if (context.TracksDefinition.Basic[QueuedData.Type].Kind == BasicEventKind.IntValue
    ...
    {
        if (context.TracksDefinition.Basic[QueuedData.Type].Kind != BasicEventKind.Lights)
        {
    ...
    {
        if (context.TracksDefinition.Basic[QueuedData.Type].Kind != BasicEventKind.Lights) return;
