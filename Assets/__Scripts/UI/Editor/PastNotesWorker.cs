...
public class PastNotesWorker : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        callbackController.OnNotePassedThreshold += OnNotePassedThreshold;
    ...
    private void OnTimeChanged()
    {
        ...
        foreach (var note in lastGroup) OnNotePassedThreshold(false, 0, note);
    }

    private void OnNotePassedThreshold(bool natural, int id, BaseObject obj)
    {
