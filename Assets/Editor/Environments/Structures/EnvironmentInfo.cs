...
public class LightTracksDefinition
{
    ...
    public class PageDefinition
    {
        ...
        [JsonProperty("colorTrack")] public bool ColorTrack = false;
        [JsonProperty("floatFxTrack")] public bool FloatFxTrack = false;
        [JsonProperty("duplicate")] public bool Duplicate = false;
...
public class EnvColorScheme
{
    ...
    public void CopyTo(PlatformColorScheme copy)
    {
